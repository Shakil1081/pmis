...
class ForestRangesApiController extends Controller
{
    public function index()
    {
        ...
        return new ForestRangeResource(ForestRange::with(['forest_state', 'status', 'forest_division'])->get());
    }
    ...
    public function show(ForestRange $forestRange)
    {
        ...
        return new ForestRangeResource($forestRange->load(['forest_state', 'status', 'forest_division']));
    }
