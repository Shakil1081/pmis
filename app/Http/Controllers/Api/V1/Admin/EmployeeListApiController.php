...
class EmployeeListApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new EmployeeListResource(EmployeeList::with(['batch', 'home_district', 'marital_statu', 'gender', 'religion', 'blood_group', 'license_type', 'projectrevenue', 'joiningexaminfo', 'departmental_exam', 'project', 'grade', 'quota'])->get());
    }
    ...
    public function show(EmployeeList $employeeList)
    {
        ...
        return new EmployeeListResource($employeeList->load(['batch', 'home_district', 'marital_statu', 'gender', 'religion', 'blood_group', 'license_type', 'projectrevenue', 'joiningexaminfo', 'departmental_exam', 'project', 'grade', 'quota']));
    }
