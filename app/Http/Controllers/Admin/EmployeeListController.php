...
class EmployeeListController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = EmployeeList::with(['batch', 'home_district', 'marital_statu', 'gender', 'religion', 'blood_group', 'license_type', 'projectrevenue', 'joiningexaminfo', 'departmental_exam', 'project', 'grade', 'quota'])->select(sprintf('%s.*', (new EmployeeList)->table));
            ...
            $table->addColumn('projectrevenue_project_revenue_bn', function ($row) {
                return $row->projectrevenue ? $row->projectrevenue->project_revenue_bn : '';
            });
            ...
            $table->addColumn('departmental_exam_name_bn', function ($row) {
                return $row->departmental_exam ? $row->departmental_exam->name_bn : '';
            });

            $table->addColumn('project_name_bn', function ($row) {
                return $row->project ? $row->project->name_bn : '';
            });

            $table->editColumn('certificate_upload', function ($row) {
                return $row->certificate_upload ? '<a href="' . $row->certificate_upload->getUrl() . '" target="_blank">' . trans('global.downloadFile') . '</a>' : '';
            });
            ...
            $table->editColumn('freedomfighter', function ($row) {
                return $row->freedomfighter ? $row->freedomfighter : '';
            });

            $table->rawColumns(['actions', 'placeholder', 'batch', 'home_district', 'marital_statu', 'gender', 'religion', 'blood_group', 'license_type', 'projectrevenue', 'joiningexaminfo', 'departmental_exam', 'project', 'certificate_upload', 'grade', 'first_joining_order', 'fjoining_letter', 'date_of_gazette_if_any', 'regularization_office_orde_go', 'confirmation_in_service', 'quota']);
    ...
    public function edit(EmployeeList $employeeList)
    {
        ...
        $employeeList->load('batch', 'home_district', 'marital_statu', 'gender', 'religion', 'blood_group', 'license_type', 'projectrevenue', 'joiningexaminfo', 'departmental_exam', 'project', 'grade', 'quota');

        return view('admin.employeeLists.edit', compact('batches', 'blood_groups', 'departmental_exams', 'employeeList', 'genders', 'grades', 'home_districts', 'joiningexaminfos', 'license_types', 'marital_status', 'projectrevenues', 'projects', 'quotas', 'religions'));
    }
