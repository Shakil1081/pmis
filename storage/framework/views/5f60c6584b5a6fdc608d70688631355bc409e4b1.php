        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.forest-ranges.store')); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 <?php echo e($errors->has('forest_state') ? 'is-invalid' : ''); ?>"
                        ...
                        <?php $__currentLoopData = $forest_states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e(old('forest_state_id') == $id ? 'selected' : ''); ?>>
                ...
                <div class="form-group">
                    <label class="required"
                        for="forest_division_id"><?php echo e(trans('cruds.forestRange.fields.forest_division')); ?></label>
                    <select class="form-control select2 <?php echo e($errors->has('forest_division') ? 'is-invalid' : ''); ?>"
                        ...
                        <?php $__currentLoopData = $forest_divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e(old('forest_division_id') == $id ? 'selected' : ''); ?>>
                                <?php echo e($entry); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo e($errors->has('name_bn') ? 'is-invalid' : ''); ?>" type="text"
                        name="name_bn" id="name_bn" value="<?php echo e(old('name_bn', '')); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo e($errors->has('name_en') ? 'is-invalid' : ''); ?>" type="text"
                        name="name_en" id="name_en" value="<?php echo e(old('name_en', '')); ?>" required>
