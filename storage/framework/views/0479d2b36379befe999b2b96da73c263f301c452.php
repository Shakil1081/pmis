...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.forestRange.title_singular')); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.forest-ranges.update", [$forestRange->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('forest_state') ? 'is-invalid' : ''); ?>" name="forest_state_id" id="forest_state_id" required>
                    <?php $__currentLoopData = $forest_states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('forest_state_id') ? old('forest_state_id') : $forestRange->forest_state->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('forest_division_bbs_code') ? 'is-invalid' : ''); ?>" type="text" name="forest_division_bbs_code" id="forest_division_bbs_code" value="<?php echo e(old('forest_division_bbs_code', $forestRange->forest_division_bbs_code)); ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>" name="status_id" id="status_id" required>
                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('status_id') ? old('status_id') : $forestRange->status->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('forest_division') ? 'is-invalid' : ''); ?>" name="forest_division_id" id="forest_division_id" required>
                    <?php $__currentLoopData = $forest_divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('forest_division_id') ? old('forest_division_id') : $forestRange->forest_division->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('name_bn') ? 'is-invalid' : ''); ?>" type="text" name="name_bn" id="name_bn" value="<?php echo e(old('name_bn', $forestRange->name_bn)); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('name_en') ? 'is-invalid' : ''); ?>" type="text" name="name_en" id="name_en" value="<?php echo e(old('name_en', $forestRange->name_en)); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\2024working\pims2024\pmis\resources\views/admin/forestRanges/edit.blade.php ENDPATH**/ ?>