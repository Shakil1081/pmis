<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('office_config_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/designations*') ? 'c-show' : '' }} {{ request()->is('admin/leave-categories*') ? 'c-show' : '' }} {{ request()->is('admin/leave-types*') ? 'c-show' : '' }} {{ request()->is('admin/training-types*') ? 'c-show' : '' }} {{ request()->is('admin/travel-purposes*') ? 'c-show' : '' }} {{ request()->is('admin/license-types*') ? 'c-show' : '' }} {{ request()->is('admin/grades*') ? 'c-show' : '' }} {{ request()->is('admin/traveltypes*') ? 'c-show' : '' }} {{ request()->is('admin/batches*') ? 'c-show' : '' }} {{ request()->is('admin/joininginfos*') ? 'c-show' : '' }} {{ request()->is('admin/project-revenuelones*') ? 'c-show' : '' }} {{ request()->is('admin/project-revenue-exams*') ? 'c-show' : '' }} {{ request()->is('admin/years*') ? 'c-show' : '' }} {{ request()->is('admin/projects*') ? 'c-show' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @can('job_configuration_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/job-types*') ? 'c-show' : '' }} {{ request()->is('admin/forest-states*') ? 'c-show' : '' }} {{ request()->is('admin/forest-ranges*') ? 'c-show' : '' }} {{ request()->is('admin/forest-beats*') ? 'c-show' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
