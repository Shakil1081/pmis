<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('job_configuration_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/job-types*") ? "c-show" : "" }} {{ request()->is("admin/forest-states*") ? "c-show" : "" }} {{ request()->is("admin/forest-ranges*") ? "c-show" : "" }} {{ request()->is("admin/forest-beats*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
