    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.education-informationes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="name_of_exam_id">{{ trans('cruds.educationInformatione.fields.name_of_exam') }}</label>
                <select class="form-control select2 {{ $errors->has('name_of_exam') ? 'is-invalid' : '' }}" name="name_of_exam_id" id="name_of_exam_id" required>
                    @foreach($name_of_exams as $id => $entry)
                        <option value="{{ $id }}" {{ old('name_of_exam_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('exam_board') ? 'is-invalid' : '' }}" name="exam_board_id" id="exam_board_id" required>
                    @foreach($exam_boards as $id => $entry)
                        <option value="{{ $id }}" {{ old('exam_board_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('concentration_major_group') ? 'is-invalid' : '' }}" type="text" name="concentration_major_group" id="concentration_major_group" value="{{ old('concentration_major_group', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('school_university_name') ? 'is-invalid' : '' }}" type="text" name="school_university_name" id="school_university_name" value="{{ old('school_university_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passing_year') ? 'is-invalid' : '' }}" type="number" name="passing_year" id="passing_year" value="{{ old('passing_year', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('achievement_types') ? 'is-invalid' : '' }}" name="achievement_types_id" id="achievement_types_id">
                    @foreach($achievement_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('achievement_types_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('achivement') ? 'is-invalid' : '' }}" type="text" name="achivement" id="achivement" value="{{ old('achivement', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exam_degree') ? 'is-invalid' : '' }}" type="text" name="exam_degree" id="exam_degree" value="{{ old('exam_degree', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cgpa') ? 'is-invalid' : '' }}" type="text" name="cgpa" id="cgpa" value="{{ old('cgpa', '') }}">
                @if($errors->has('cgpa'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cgpa') }}
                    </div>
