...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.serviceParticular.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.service-particulars.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_status') ? 'is-invalid' : '' }}" type="text" name="designation_status" id="designation_status" value="{{ old('designation_status', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_organization_institute') ? 'is-invalid' : '' }}" type="text" name="office_organization_institute" id="office_organization_institute" value="{{ old('office_organization_institute', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('release_date') ? 'is-invalid' : '' }}" type="text" name="release_date" id="release_date" value="{{ old('release_date') }}">
