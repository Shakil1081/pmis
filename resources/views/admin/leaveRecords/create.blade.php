                ...
                <div class="tab-content my-1 border p-2" id="v-pills-tabContent">
                    ...
                    <form method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    @foreach ($leave_categories as $id => $entry)
                                        <option value="{{ $id }}" {{ old('leave_category_id') == $id ? 'selected' : '' }}>
                                            {{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    @foreach ($type_of_leaves as $id => $entry)
                                        <option value="{{ $id }}" {{ old('type_of_leave_id') == $id ? 'selected' : '' }}>
                                            {{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor {{ $errors->has('reason') ? 'is-invalid' : '' }}"
                                name="reason" id="reason">{!! old('reason') !!}</textarea>
