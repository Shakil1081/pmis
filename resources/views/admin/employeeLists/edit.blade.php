                ...
                <div class="row row-cols-3">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('prl_date') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('prl_date', $employeeList->prl_date) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('projectrevenue') ? 'is-invalid' : '' }}"
                            name="projectrevenue_id" id="projectrevenue_id">
                    ...
                    <div class="form-group">
                        <label
                            for="first_joining_order">{{ trans('cruds.employeeList.fields.first_joining_order') }}</label>
