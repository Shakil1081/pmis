        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.employee-lists.update', [$employeeList->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-select select2 {{ $errors->has('projectrevenue') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($projectrevenues as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('projectrevenue_id') ? old('projectrevenue_id') : $employeeList->projectrevenue->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select select2 {{ $errors->has('departmental_exam') ? 'is-invalid' : '' }}"
                        name="departmental_exam_id" id="departmental_exam_id">
                        @foreach ($departmental_exams as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('departmental_exam_id') ? old('departmental_exam_id') : $employeeList->departmental_exam->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select select2 {{ $errors->has('project') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-select select2 {{ $errors->has('freedomfighter') ? 'is-invalid' : '' }}"
