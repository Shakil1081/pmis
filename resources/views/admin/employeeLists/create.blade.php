        ...
        <form method="POST" id="myForm"
            ...
            <div class="card border-secondary border p-4">
                ...
                <div class="row row-cols-3">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('prl_date') ? 'is-invalid' : '' }}" type="date"
                            name="prl_date" id="prl_date" readonly>
                    ...
                    {{-- <div class="form-group">
                        <label class="required" for="religion_id">{{ trans('cruds.employeeList.fields.religion')
                            }}</label>
            ...
            <div class="card border-secondary border p-4">
                <div class="row row-cols-3">
                    ...
                    <div class="form-group">
                        <label class="required"
                            for="mobile_number">@if (app()->getLocale() === 'bn')
                ...
                <div class="row row-cols-3">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('nid') ? 'is-invalid' : '' }}" type="number"
                            name="nid" id="nid" value="{{ old('nid', '') }}" step="1" minlength="8" maxlength="20"
                            required>
                        @if ($errors->has('nid'))
                            <div class="invalid-feedback">
                                {{ $errors->first('nid') }}
...
@else
    ...
    @endif
                    ...
                    <div class="form-group license_fields" style="display: none;">
                        ...
                        <select class="form-control select2 {{ $errors->has('license_type') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($license_types as $id => $entry)
                                        <option value="{{ $id }}" {{ old('license_type_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                </option>
                            @endforeach
                            </select>
            ...
            @endif</label>
                ...
                <div class="form-group">
                        <label
                            for="first_joining_g_o_date">@if (app()->getLocale() === 'bn')
                প্রথম নিয়োগের তারিখ
            @else
                First Joining Date
            @endif</label>
                    ...
                    <div class="form-group">
                        <label
                            for="first_joining_order">@if (app()->getLocale() === 'bn')
            ...
            <span class="help-block">{{ trans('cruds.employeeList.fields.fjoining_date_helper') }}</span>
                    ...
                    <div class="form-group">
                        <label for="fjoining_letter">@if (app()->getLocale() === 'bn')
            ...
            @endif</label>
                    ...
                    <div class="form-group">
                        <label
                            for="date_of_gazette_if_any">@if (app()->getLocale() === 'bn')
                            গেজেট আদেশ সংযোজন
            @else
            ...
            @endif</label>
                    ...
                    <div class="form-group">
                        <label
                            for="confirmation_in_service">@if (app()->getLocale() === 'bn')
            ...
            @endif</label>
                    ...
                    <div class="form-group">
                        <label class="required" for="quota_id">{{ trans('cruds.employeeList.fields.quota') }}</label>
        ...
        <button class="btn btn-lg btn-success w-100 px-5" type="submit" onclick="return confirmSubmission()">
            {{ trans('global.save') }}
        </button>
    </div>
        </form>
