    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employee-lists.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nid') ? 'is-invalid' : '' }}" type="number" name="nid" id="nid" value="{{ old('nid', '') }}" step="1">
                @if($errors->has('nid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nid') }}
                    </div>
            ...
            <div class="form-group">
                <label for="project_revenue">{{ trans('cruds.employeeList.fields.project_revenue') }}</label>
                <input class="form-control {{ $errors->has('project_revenue') ? 'is-invalid' : '' }}" type="text" name="project_revenue" id="project_revenue" value="{{ old('project_revenue', '') }}">
                @if($errors->has('project_revenue'))
                    <div class="invalid-feedback">
                        {{ $errors->first('project_revenue') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.employeeList.fields.project_revenue_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('freedomfighter') ? 'is-invalid' : '' }}" type="text" name="freedomfighter" id="freedomfighter" value="{{ old('freedomfighter', '') }}">
