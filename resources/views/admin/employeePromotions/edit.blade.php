            ...
            <form method="POST" action="{{ route('admin.employee-promotions.update', [$employeePromotion->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('go_issue_date') ? 'is-invalid' : '' }}" type="text"
                        name="go_issue_date" id="go_issue_date"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('office_order_date') ? 'is-invalid' : '' }}"
                        type="text" name="office_order_date" id="office_order_date"
                        value="{{ old('office_order_date', $employeePromotion->office_order_date) }}" required>
