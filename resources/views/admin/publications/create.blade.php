    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.publications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('publication_type') ? 'is-invalid' : '' }}" name="publication_type" id="publication_type" required>
                    ...
                    @foreach(App\Models\Publication::PUBLICATION_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('publication_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('publication_media') ? 'is-invalid' : '' }}" type="text" name="publication_media" id="publication_media" value="{{ old('publication_media', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('publication_link') ? 'is-invalid' : '' }}" type="text" name="publication_link" id="publication_link" value="{{ old('publication_link', '') }}">
