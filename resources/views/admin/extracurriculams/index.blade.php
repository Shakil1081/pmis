...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Extracurriculam">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'attatchment', name: 'attatchment', sortable: false, searchable: false },
