                ...
                <div class="tab-content my-1 border p-2" id="v-pills-tabContent">
                    ...
                    <form method="POST"
                        ...
                        <div class="row row-cols-2">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('judgement_type') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('judgement_type', '') }}" required>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            {{-- <span class="form-text">{{
                                                trans('cruds.criminalProsecutionDerail.fields.govt_order_file_helper')
                                                }}</span> --}}
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor {{ $errors->has('remzrk') ? 'is-invalid' : '' }}"
                                name="remzrk" id="remzrk">{!! old('remzrk') !!}</textarea>
