    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.criminal-prosecutiones.update", [$criminalProsecutione->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('government_order_date') ? 'is-invalid' : '' }}" type="text" name="government_order_date" id="government_order_date" value="{{ old('government_order_date', $criminalProsecutione->government_order_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('court_name') ? 'is-invalid' : '' }}" type="text" name="court_name" id="court_name" value="{{ old('court_name', $criminalProsecutione->court_name) }}">
