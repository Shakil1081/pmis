...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.spouseInformatione.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.spouse-informationes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nid_number') ? 'is-invalid' : '' }}" type="text" name="nid_number" id="nid_number" value="{{ old('nid_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_address') ? 'is-invalid' : '' }}" type="text" name="office_address" id="office_address" value="{{ old('office_address', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('present_addess') ? 'is-invalid' : '' }}" name="present_addess" id="present_addess">{!! old('present_addess') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('permanent_addess') ? 'is-invalid' : '' }}" name="permanent_addess" id="permanent_addess">{!! old('permanent_addess') !!}</textarea>
