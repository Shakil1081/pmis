            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="tab-content my-1 border p-2" id="v-pills-tabContent">
                        <h4> {{ trans('global.create') }} {{ trans('cruds.spouseInformatione.title_singular') }}</h4>
                        <form method="POST"
                            action="{{ route('admin.spouse-informationes.store', ['employee_id' => request()->query('id')]) }}"
                            ...
                            <div class="row row-cols-2">
                                ...
                                <div class="form-group">
                                    <label
                                        for="occupation">{{ trans('cruds.spouseInformatione.fields.occupation') }}</label>
