    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.criminalpro-disciplinaries.update", [$criminalproDisciplinary->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('judgement_type') ? 'is-invalid' : '' }}" type="text" name="judgement_type" id="judgement_type" value="{{ old('judgement_type', $criminalproDisciplinary->judgement_type) }}">
