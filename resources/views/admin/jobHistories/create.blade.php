...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.jobHistory.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.job-histories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('release_date') ? 'is-invalid' : '' }}" type="text" name="release_date" id="release_date" value="{{ old('release_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_4') ? 'is-invalid' : '' }}" type="text" name="level_4" id="level_4" value="{{ old('level_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_5') ? 'is-invalid' : '' }}" type="text" name="level_5" id="level_5" value="{{ old('level_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institutename') ? 'is-invalid' : '' }}" type="text" name="institutename" id="institutename" value="{{ old('institutename', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('academy_type') ? 'is-invalid' : '' }}" type="text" name="academy_type" id="academy_type" value="{{ old('academy_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('acadaylocation') ? 'is-invalid' : '' }}" type="text" name="acadaylocation" id="acadaylocation" value="{{ old('acadaylocation', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('posting_in_circle') ? 'is-invalid' : '' }}" type="text" name="posting_in_circle" id="posting_in_circle" value="{{ old('posting_in_circle', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postingindivision') ? 'is-invalid' : '' }}" type="text" name="postingindivision" id="postingindivision" value="{{ old('postingindivision', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('posting_in_range') ? 'is-invalid' : '' }}" type="text" name="posting_in_range" id="posting_in_range" value="{{ old('posting_in_range', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('circle_list') ? 'is-invalid' : '' }}" name="circle_list_id" id="circle_list_id">
                    @foreach($circle_lists as $id => $entry)
                        <option value="{{ $id }}" {{ old('circle_list_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('division_list') ? 'is-invalid' : '' }}" name="division_list_id" id="division_list_id">
                    @foreach($division_lists as $id => $entry)
                        <option value="{{ $id }}" {{ old('division_list_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('range_list') ? 'is-invalid' : '' }}" name="range_list_id" id="range_list_id">
                    @foreach($range_lists as $id => $entry)
                        <option value="{{ $id }}" {{ old('range_list_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('beat_list') ? 'is-invalid' : '' }}" name="beat_list_id" id="beat_list_id">
                    @foreach($beat_lists as $id => $entry)
                        <option value="{{ $id }}" {{ old('beat_list_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('office_unit') ? 'is-invalid' : '' }}" name="office_unit_id" id="office_unit_id" required>
                    @foreach($office_units as $id => $entry)
                        <option value="{{ $id }}" {{ old('office_unit_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
