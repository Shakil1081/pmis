...
@can('professionale_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Professionale', 'route' => 'admin.professionales.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Professionale">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'qualification_title', name: 'qualification_title' },
